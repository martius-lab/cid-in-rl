...
"""Provide gin configurables for Pytorch

Copied from
https://github.com/google/gin-config/blob/master/gin/torch/external_configurables.py

Can be removed once a new version of gin is released on Pypi
"""
...
config.external_configurable(
    torch.nn.init.calculate_gain, module='torch.nn.init')
config.external_configurable(
    torch.nn.init.uniform_, module='torch.nn.init')
config.external_configurable(
    torch.nn.init.normal_, module='torch.nn.init')
config.external_configurable(
    torch.nn.init.constant_, module='torch.nn.init')
config.external_configurable(
    torch.nn.init.ones_, module='torch.nn.init')
config.external_configurable(
    torch.nn.init.zeros_, module='torch.nn.init')
config.external_configurable(
    torch.nn.init.eye_, module='torch.nn.init')
config.external_configurable(
    torch.nn.init.dirac_, module='torch.nn.init')
config.external_configurable(
    torch.nn.init.xavier_uniform_, module='torch.nn.init')
config.external_configurable(
    torch.nn.init.xavier_normal_, module='torch.nn.init')
config.external_configurable(
    torch.nn.init.kaiming_uniform_, module='torch.nn.init')
config.external_configurable(
    torch.nn.init.kaiming_normal_, module='torch.nn.init')
config.external_configurable(
    torch.nn.init.orthogonal_, module='torch.nn.init')
config.external_configurable(
    torch.nn.init.sparse_, module='torch.nn.init')
